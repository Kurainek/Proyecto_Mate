...
class AplicacionRutaOptima:
    def __init__(self, ventana):
        ...
        # Paleta de colores solicitada: Negro, Azul, Blanco
        self.BG_MAIN = "#000000"       
    ...
    def actualizar_grafico(self, ruta_optima=None):
        ...
        nx.draw_networkx_labels(G, posiciones, ax=self.ax, font_size=8, font_weight="bold", font_color="#000000")
    ...
    def calcular_ruta_optima(self):
        ...
        try:
            ...
            # Cálculo de tiempo en auto (velocidad promedio realista de carreteras: 80 km/h)
